...
public class GlobalSpace {
	...
	public static final gmNext(X) ((X + m_data.rules.rot_addn) % gmTOTAL_PLAYERS)
	public static final gmTrickNext ((m_data.tricks[m_data.trick_round].lead_loc + (m_data.tricks[m_data.trick_round].count * m_data.rules.rot_addn)) % 4)
	public static final gmWinnerCard (m_data.tricks[m_data.trick_round].cards[m_data.tricks[m_data.trick_round].winner])
	...
	public static final gmPartner(X) ((X + 2) % gmTOTAL_PLAYERS)
	...
	public static final gmGetSuit(X) (X / gmTOTAL_VALUES)
	public static final gmGetValue(X) (X % gmTOTAL_VALUES)
	public static final gmGetTeam(X) (X % gmTOTAL_TEAMS)
	public static final gmGetOpponent(X) ((X + 1) % gmTOTAL_TEAMS)
	public static final gmGetPartner(X) ((X + 2) % gmTOTAL_PLAYERS)
	public static final gmGetOpponentOne(X) ((X + 1) % gmTOTAL_PLAYERS)
	public static final gmGetOpponentTwo(X) ((X + 3) % gmTOTAL_PLAYERS)

	//public static final raGET_CARD_INDEX(crd) ((crd.GetSuit() << 3) + gmUtil.m_value_trans[crd.GetValue()])
	
	// Calculates the total number of points in a hand
	public static final gmTotalPoints(X) ( gmUtil.m_total_points[(gmUtil.m_suit_mask[0] & X) >> gmUtil.m_suit_rs[0]] + gmUtil.m_total_points[(gmUtil.m_suit_mask[1] & X) >> gmUtil.m_suit_rs[1]] + gmUtil.m_total_points[(gmUtil.m_suit_mask[2] & X) >> gmUtil.m_suit_rs[2]] + gmUtil.m_total_points[(gmUtil.m_suit_mask[3] & X) >> gmUtil.m_suit_rs[3]])
	...
	public static final int raBID_BTN_ID_MAX = (raBID_BTN_ID_START + raBID_TOTAL_BTNS - 1);
	...
	public static final raGetBidFromId(X) (X - raBID_BTN_ID_START + 14)
	...
	public static final String RA_APP_FULL_VER =RA_APP_MAJOR_VER +(".") +RA_APP_MINOR_VER +RA_APP_REL_TYPE +RA_APP_REL_TYPE_VER;

	public static final String RA_APP_FULL_NAME =RA_APP_NAME+ (" ") +RA_APP_FULL_VER;


	public static final String ra_APP_URL =("http://rosanne.sourceforge.net");

	public static final int raBID_INVALID =-2;
	public static final raGetRandPlayer() (gen_rand32() % gmTOTAL_PLAYERS)
	...
	public static final raStatusBar ((wxFrame *)(wxTheApp.GetTopWindow())).GetStatusBar()
	...
	//public static final String raUPDATE_APPURL "http://rosanne.sourceforge.net"
}
